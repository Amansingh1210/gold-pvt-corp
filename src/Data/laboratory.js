...
const laboratory = [
  ...
  },
  {
  ...
  },
    {
      ...
      name: "Automobile lab",
      items: [
        { src: log35, name: "SIX CYLINDER DIESEL ENGINE" },
        { src: log36, name: "FUEL TANK" },
        { src: log37, name: "DIESEL ENGINE CRDI" },
        { src: log38, name: "ELECTRIC DYNAMOMETER" },
        { src: log39, name: "SINGLE CYLINDER DIESEL ENGINE" },
        { src: log40, name: "FOUR STROKE DIESEL ENGINE" },
        { src: log41, name: "FOUR STROKE PETROL ENGINE" },
      ],
    },
    {
      id: 5,
